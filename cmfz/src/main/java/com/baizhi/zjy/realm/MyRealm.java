package com.baizhi.zjy.realm;

import com.baizhi.zjy.dao.AdminDao;
import com.baizhi.zjy.entity.Admin;
import com.baizhi.zjy.entity.Resource;
import com.baizhi.zjy.entity.Role;
...
public class MyRealm extends AuthorizingRealm {
    @Override
    //doGetAuthorizationInfo获取授权信息的方法
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principalCollection) {
        ...
        //返回值信息  使用SimpleAuthorizationInfo 类型 不要使用父类引用
