    ...
    <div class="container-fluid">
        ...
        <div>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a>欢迎:<font color="red"><shiro:principal></shiro:principal></font></a></li>
                <li><a href="${pageContext.request.contextPath}/chu/logOut">退出登陆</a></li>
            </ul>
        </div>
    </div>
</nav>
            ...
            <shiro:hasRole name="superadmin">
                <div class="panel panel-default">
                    ...
                    <div id="collapseSix" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="nav">
                                <li><a href="javascript:$('#centerLay').load('')">管理员管理</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="../img/timg.jpg" alt="First slide">
                            <div class="carousel-caption">标题 1</div>
                        </div>
                        <div class="item">
                            <img src="../img/vv.jpg" alt="Second slide">
                            <div class="carousel-caption">标题 2</div>
                        </div>
                        <div class="item">
                            <img src="../img/yy.jpg" alt="Third slide">
